...
module.exports = {
  ...
  entry: './src/react_minesweeper.jsx', //this is assuming that we have a frontend folder that has the entry file

  // tell webpack where to output bundled js file
  output: {
    // use path module to get absolute path to current directory (2 underscores)
    path: path.resolve(__dirname),
    filename: './public/bundle.js' //change this to point to same folder of index.html file
  },
